...
public class DiagnosisService {
    ...
    public byte[] generatePrescription(String diagnosisDetails) {
        try {
            ...
            com.itextpdf.text.Image chartImage = com.itextpdf.text.Image.getInstance(chartOut.toByteArray());
            chartImage.setAlignment(com.itextpdf.text.Image.ALIGN_CENTER);
                ...
                if (saleAnalysis != null) {
                    ...
                    for (String sentence : sentences) {
                        ...
                        if (inputStream != null) {
                            ...
                            leftCell1.setBorder(com.itextpdf.text.Rectangle.NO_BORDER);
                        ...
                        rightCell1.setBorder(com.itextpdf.text.Rectangle.NO_BORDER);
